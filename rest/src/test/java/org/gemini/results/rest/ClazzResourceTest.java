...
public class ClazzResourceTest extends JerseyTest {
    ...
    public void testList() {
...

        {
            final Response response = target(String.format(
                    "competition/%s/class", competitionId)).request().get();
        ...
        {
            final Response response = target(String.format(
                    "competition/%s/class", competitionId)).queryParam(
        ...
        {
            final Response response = target(String.format(
                    "competition/huuhaa/class")).request().get();
    ...
    public void testGet() {
        ...
        {
            final Response response = target(String.format(
                    "competition/%s/class/%s", competitionId, clazz.getId()))
                    .request().get();
        ...
        { // class not found
            final Response response = target(String.format(
                    "competition/%s/class/huuhaa", competitionId))
                    .request().get();
        ...
        { // class not found
            final Response response = target(String.format(
                    "competition/huuhaa/class/%s", clazz.getId()))
                    .request().get();
    ...
    public void testCreate() {
...

        {
            ...
            final Response response = target(String.format(
                    "competition/%s/class/%s", competitionId, validClassId))
        ...
        { // Competition not found
            ...
            final Response response = target(String.format(
                    "competition/huuhaa/class/%s", validClassId))
                    .request().post(Entity.xml(clazz));
    ...
    public void testUpdate() {
        ...
        { // Create
            final Response response = target(String.format(
                    "competition/%s/class/%s", competitionId, clazzId))
                    .request().post(Entity.xml(clazz));
            Assert.assertEquals(201, response.getStatus());
        }
        ...
        { // Competition not found
            ...
            final Response response = target(String.format(
                    "competition/huuhaa/class/%s", clazzId))
                    .request().put(Entity.xml(clazz));
